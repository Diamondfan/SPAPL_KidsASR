...
if [ $stage -le 1 ] && [ $end_stage -ge 1 ]; then
  ...
  #exp_dir="exp/wavlm_large_fullfinetuning_lr3e-4_specaugt075f05_2gpus_bth8_grad2_12ksteps_warm1k/"
  exp_dir="exp/hubert_large_fullfinetuning_lr3e-4_specaugt05f05_2gpus_bth8_grad2_12ksteps_warm1k/"
  #exp_dir="exp/wav2vec2_large_fullfinetuning_lr3e-4_2gpus_bth8_grad2_12ksteps_warm1k/"

  [ ! -d $exp_dir ] && mkdir -p $exp_dir

  train_config=conf/hubert_train.yaml
  #train_config=conf/wavlm_train.yaml
  #train_config=conf/wav2vec_train.yaml
  
  CUDA_VISIBLE_DEVICES="0,1" torchrun --rdzv-endpoint=localhost:12345 \
 	  --nproc_per_node 2 $rootdir/src/bin/train_asr_ctc.py $train_config > $exp_dir/train.log 2>&1 &
...
if [ $stage -le 2 ] && [ $end_stage -ge 2 ]; then
  ...
  exp_dir="exp/wavlm_large_fullfinetuning_lr3e-4_specaugt05f05_2gpus_bth8_grad2_12ksteps_warm1k/"
  #exp_dir="exp/hubert_large_fullfinetuning_lr3e-4_specaugt05f05_2gpus_bth8_grad2_12ksteps_warm1k/"
  #exp_dir="exp/wav2vec2_large_fullfinetuning_lr3e-4_2gpus_bth8_grad2_12ksteps_warm1k/"
